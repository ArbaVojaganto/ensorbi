 ...
 */
export class TemporaryQueryNode extends Node {
  public type: NodeType = 'TemporaryQuery' as const
  constructor(
    hash: string,
    title: string,
    createdAt: string,
  ...
  public static validation = (meta: any): meta is TemporaryQueryNode => {
    if (meta.type != "TemporaryQuery") return false
